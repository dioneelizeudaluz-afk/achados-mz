...
import { FileText, MapPin, User, Phone, Calendar, CheckCircle } from 'lucide-react'
...
export default function RegisterLost() {
    ...
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-600 mt-2">
          Recebera notificacao se alguem encontrar o seu documento.
        </p>
        <Button
          className="mt-6"
          onClick={() => navigate('/')}
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-bold text-gray-900">Comunicar Documento Perdido</h1>
      <p className="text-gray-600">
        Perdeu um documento? Registe para receber alertas de correspondencias.
      </p>
      ...
      <form onSubmit={handleSubmit} className="space-y-4 bg-white rounded-lg p-6 shadow-sm">
        ...
        <Input
          ...
          required
          icon={Phone}
          placeholder="Para receber notificacoes"
